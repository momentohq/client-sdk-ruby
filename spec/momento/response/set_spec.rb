...
RSpec.describe Momento::Response::Set do
  ...
  describe '.from_block' do
    context 'when it is InvalidArgument' do
      ...
      let(:response_class) { Momento::Response::Set::InvalidArgument }
    ...
    context 'when it is NotFound' do
      ...
      let(:response_class) { Momento::Response::Set::NotFound }
    ...
    context 'when it is PermissionDenied' do
      ...
      let(:response_class) { Momento::Response::Set::PermissionDenied }
