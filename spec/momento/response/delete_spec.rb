...
RSpec.describe Momento::Response::Delete do
  ...
  describe '.from_block' do
    context 'when it is InvalidArgument' do
      ...
      let(:response_class) { Momento::Response::Delete::InvalidArgument }
    ...
    context 'when it is NotFound' do
      ...
      let(:response_class) { Momento::Response::Delete::NotFound }
    ...
    context 'when it is PermissionDenied' do
      ...
      let(:response_class) { Momento::Response::Delete::PermissionDenied }
